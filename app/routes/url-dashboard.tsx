...
const Dashboard = () => {
	...
	return (
		<div className="flex flex-col h-[90vh] justify-center">
			<Card className="w-1/2 mx-auto px-3 py-5">
						...
						<Table>
							<TableHeader>
								<TableRow>
									...
									<TableHead className="text-right">Number of Clicks</TableHead>
								...
								{loaderData?.map((data, index) => (
									<TableRow key={data._id}>
										...
										<TableCell className="underline">
											<Link to={`/info/${data.shortId}`}>{data.shortId}</Link>
										</TableCell>
												...
												<AlertDialogContent>
													<AlertDialogHeader>
														...
														<AlertDialogDescription>
															...
															permanently delete your URL details and remove the
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											...
											all the URL details and remove the data from our servers.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
										<AlertDialogCancel>Cancel</AlertDialogCancel>
